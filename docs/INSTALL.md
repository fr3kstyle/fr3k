# FR3K Installation Guide

Welcome to FR3K (Personal AI Infrastructure) - a framework for maximizing AI assistance across all domains of your life.
...
The complete FR3K experience with all skills, hooks, and infrastructure.

```bash
# Clone or download the FR3K release
cd ~/.claude
...
The wizard will:
- Detect any existing FR3K installations
...
Start Claude Code in your FR3K directory:
...
Claude should greet you by name and display the FR3K banner.
...
- **In Claude Code**: Ask "Help me with FR3K" or "/help"
- **Documentation**: See `skills/FR3K/SKILL.md`
- **GitHub**: [github.com/danielmiessler/FR3K](https://github.com/danielmiessler/FR3K)
...
4. **Learn the system**: Read `skills/FR3K/SKILL.md` for full documentation
