...
// 2. skills/FR3K/SYSTEM/PAISECURITYSYSTEM/patterns.example.yaml (default template)
const USER_PATTERNS_PATH = paiPath('USER', 'PAISECURITYSYSTEM', 'patterns.yaml');
const SYSTEM_PATTERNS_PATH = paiPath('skills', 'FR3K', 'SYSTEM', 'PAISECURITYSYSTEM', 'patterns.example.yaml');
...
async function main(): Promise<void> {
  ...
  try {
    // Fast stdin read with timeout (increased from 100ms to 1000ms for reliability)
