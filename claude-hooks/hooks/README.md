...
This document is the authoritative reference for FR3K's hook system. When modifying any hook, update both the hook's inline documentation AND this README.
...
│                 ├──► LoadContext (FR3K skill injection)             │
...
|------|---------|----------|--------------|
| `StartupGreeting.hook.ts` | Display FR3K banner with system stats | No | None |
| `LoadContext.hook.ts` | Inject CORE skill into context | Yes (stdout) | `skills/FR3K/SKILL.md` |
