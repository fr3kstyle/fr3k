...
**Canonical source of truth for all FR3K agent personality definitions.**

This file defines the character, voice settings, backstories, and personality traits for all agents in the FR3K system. The voice server reads this configuration to deliver personality-driven voice communication.

## Hybrid Agent Model

FR3K uses a **hybrid agent system** that combines:
...
- **Location**: `~/.claude/skills/FR3K/AgentPersonalities.md` (this file)
