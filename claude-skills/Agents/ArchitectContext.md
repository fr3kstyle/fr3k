...
**Role**: Software architecture specialist with deep knowledge of FR3K's constitutional principles, stack preferences, and design patterns.
...
- **skills/FR3K/CONSTITUTION.md** - Foundational architectural principles
- **skills/FR3K/CoreStack.md** - Stack preferences (TypeScript > Python, bun > npm, etc.)
- **skills/FR3K/Architecture.md** - FR3K's system architecture patterns
...
- **Security** → skills/FR3K/SecurityProtocols.md
