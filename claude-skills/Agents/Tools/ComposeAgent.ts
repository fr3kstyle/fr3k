 ...
 *   User:  ~/.claude/skills/FR3K/USER/SKILLCUSTOMIZATIONS/Agents/Traits.yaml
 *
 * Usage:
...
const USER_TRAITS_PATH = `${HOME}/.claude/skills/FR3K/USER/SKILLCUSTOMIZATIONS/Agents/Traits.yaml`;
...
CONFIGURATION:
  ...
  User traits:  ~/.claude/skills/FR3K/USER/SKILLCUSTOMIZATIONS/Agents/Traits.yaml
