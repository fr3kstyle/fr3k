...
`~/.claude/skills/FR3K/USER/SKILLCUSTOMIZATIONS/Browser/`
...
**Headless by default.** All automation runs in headless mode. When the user says "show me" or wants to see what the assistant is seeing, open the URL in their preferred browser from `~/.claude/skills/FR3K/USER/TECHSTACKPREFERENCES.md`:
