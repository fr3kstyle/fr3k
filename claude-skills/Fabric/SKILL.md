...
`~/.claude/skills/FR3K/USER/SKILLCUSTOMIZATIONS/Fabric/`
...
Instead of calling `fabric -p pattern_name`, FR3K executes patterns natively:
...
### 2026-01-18
- Initial skill creation (extracted from FR3K/Tools/fabric)
