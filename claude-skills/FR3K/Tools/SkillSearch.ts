 ...
 *
 * Usage:
 *   bun run ~/.claude/skills/FR3K/Tools/SkillSearch.ts <query>
 *   bun run ~/.claude/skills/FR3K/Tools/SkillSearch.ts "scrape instagram"
 *   bun run ~/.claude/skills/FR3K/Tools/SkillSearch.ts --list           # List all skills
 *   bun run ~/.claude/skills/FR3K/Tools/SkillSearch.ts --tier always    # List always-loaded skills
 *   bun run ~/.claude/skills/FR3K/Tools/SkillSearch.ts --tier deferred  # List deferred skills
 *
...
async function main() {
  ...
  if (!existsSync(INDEX_FILE)) {
    ...
    console.error('   bun run ~/.claude/skills/FR3K/Tools/GenerateSkillIndex.ts');
    process.exit(1);
  }
