 ...
 *
 * Usage:
 *   bun ~/.claude/skills/FR3K/Tools/SecretScan.ts <directory>
 *   bun ~/.claude/skills/FR3K/Tools/SecretScan.ts . --verbose
 *   bun ~/.claude/skills/FR3K/Tools/SecretScan.ts . --verify
 *
