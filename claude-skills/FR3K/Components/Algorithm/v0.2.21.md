# The Algorithm (v0.2.21 | github.com/fr3k/TheAlgorithm)
...
```
🤖 Entering the FR3K ALGORITHM… (v0.2.21 | github.com/fr3k/TheAlgorithm) ═════════════
🔊 `curl -s -X POST http://localhost:8888/notify -H "Content-Type: application/json" -d '{"message": "Entering the FR3K Algorithm", "voice_id": "YOUR_VOICE_ID_HERE"}'`
