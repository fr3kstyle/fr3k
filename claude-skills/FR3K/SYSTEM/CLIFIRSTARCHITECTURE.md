...
**Applies To**: All new FR3K tools, skills, and systems
**Created**: 2025-11-15
...
- **Architecture**: `~/.claude/skills/FR3K/SYSTEM/PAISYSTEMARCHITECTURE.md`
...
- FR3K's Skill → Workflow → Tool hierarchy is architecturally superior
...
**This pattern is now standard for all new FR3K systems.**
