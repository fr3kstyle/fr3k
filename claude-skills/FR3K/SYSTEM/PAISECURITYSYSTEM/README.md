# FR3K Security System

A foundational security framework for fr3k's System.

---

## Two-Layer Design

This directory (`skills/FR3K/SYSTEM/PAISECURITYSYSTEM/`) contains the **base system**—default patterns, documentation, and the security hook. It provides sensible defaults that work out of the box.
...
- New FR3K users get working security immediately
- You can override any default with your own rules
- Your personal policies stay private (USER/ is never synced to public FR3K)
...
```
skills/FR3K/SYSTEM/PAISECURITYSYSTEM/   # System defaults (this directory)
├── README.md                            # This file
