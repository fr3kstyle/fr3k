...
2. **SYSTEM patterns** (fallback): `skills/FR3K/SYSTEM/PAISECURITYSYSTEM/patterns.example.yaml`
...
1. Create `USER/PAISECURITYSYSTEM/patterns.yaml` (copy from `skills/FR3K/SYSTEM/PAISECURITYSYSTEM/patterns.example.yaml`)
