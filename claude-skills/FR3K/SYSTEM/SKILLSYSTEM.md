...
**The MANDATORY configuration system for ALL FR3K skills.**

---

## THIS IS THE AUTHORITATIVE SOURCE

This document defines the **required structure** for every skill in the FR3K system.
...
### System Skills (Shareable via FR3K Packs)
- Use **TitleCase** naming: `Browser`, `Research`, `Development`
- Contain NO personal data (contacts, API keys, team members)
- Reference `~/.claude/skills/FR3K/USER/` for any personalization
- Can be exported to the public FR3K repository
...
- Will NEVER be pushed to public FR3K
...
- They are automatically excluded from FR3K pack exports

**Pattern for Personalization in System Skills:**
System skills should reference FR3K/USER files for personal data:
```markdown
## Configuration
Personal configuration loaded from:
- `~/.claude/skills/FR3K/USER/CONTACTS.md` - Contact information
- `~/.claude/skills/FR3K/USER/TECHSTACKPREFERENCES.md` - Tech preferences
```
...
`~/.claude/skills/FR3K/USER/SKILLCUSTOMIZATIONS/{SkillName}/`
...
```
~/.claude/skills/FR3K/USER/SKILLCUSTOMIZATIONS/
...
1. **Create directory**: `mkdir -p ~/.claude/skills/FR3K/USER/SKILLCUSTOMIZATIONS/SkillName`
...
**Full documentation:** `~/.claude/skills/FR3K/SYSTEM/THENOTIFICATIONSYSTEM.md`
...
- ❌ Pure utility wrappers (use FR3K/SYSTEM/TOOLS.md instead)
...
**See:** `~/.claude/skills/FR3K/SYSTEM/CLIFIRSTARCHITECTURE.md` (Workflow-to-Tool Integration section)
...
**See:** `~/.claude/skills/FR3K/SYSTEM/CLIFIRSTARCHITECTURE.md` (Configuration Flags section) for full documentation
