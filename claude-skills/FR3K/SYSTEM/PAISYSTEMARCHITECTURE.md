# FR3K SYSTEM ARCHITECTURE

<!--
FR3K SYSTEM ARCHITECTURE TEMPLATE
================================
This file defines the GENERIC architecture patterns for any fr3k's System.
These are the foundational patterns that apply to ALL FR3K implementations.
...
**The Founding Principles and Universal Architecture Patterns for fr3k's System**

This document defines the foundational architecture that applies to ALL FR3K implementations. For user-specific customizations, see `USER/ARCHITECTURE.md`.

---

## Core Philosophy

**FR3K is scaffolding for AI, not a replacement for human intelligence.**

The system is designed on the principle that **AI systems need structure to be reliable**. Like physical scaffolding supports construction work, FR3K provides the architectural framework that makes AI assistance dependable, maintainable, and effective.
...
**FR3K exists to help you accomplish your goals in life—and perform the work required to get there.**

The most powerful AI systems are being built inside companies for companies. FR3K democratizes access to **personalized agentic infrastructure**—a system that knows your goals, preferences, context, and history, and uses that understanding to help you more effectively.

**What makes FR3K personal:**
...
**Key Takeaway:** AI should magnify everyone. FR3K is the infrastructure that makes AI truly personal.

### 2. The Continuously Upgrading Algorithm (THE CENTERPIECE)

**This is the gravitational center of FR3K—everything else exists to serve it.**

FR3K is built around a universal algorithm for accomplishing any task: **Current State → Ideal State** via verifiable iteration. This pattern applies at every scale—fixing a typo, building a feature, launching a company, human flourishing.
...
All of this feeds back into improving **The Algorithm itself**. FR3K is not a static tool—it is a continuously upgrading algorithm that gets better at helping you with every interaction.
...
A well-structured system with good scaffolding will outperform a more powerful model with poor structure. FR3K's value comes from:
...
**Key Takeaway:** Skills are how FR3K scales - each new domain gets its own skill.
...
```
PRIVATE: ~/.claude/                    PUBLIC: ${PROJECTS_DIR}/FR3K/
...
**FR3K manages its own integrity, security, and documentation through the System skill.**

The System skill is the centralized mechanism for FR3K self-management. It ensures the infrastructure remains healthy, secure, and well-documented.
...
|-----------|----------|------------------|
| `skills/FR3K/USER/` | Personal data, finances, health, contacts | RESTRICTED |
| `skills/FR3K/WORK/` | Customer data, consulting, client deliverables | RESTRICTED |

**Rule:** Content from USER/ and WORK/ must NEVER appear outside of them or in the public FR3K repository.
