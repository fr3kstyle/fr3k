...
```bash
mkdir -p ~/.claude/skills/FR3K/USER/SKILLCUSTOMIZATIONS/SkillName
```
...
```bash
mkdir -p ~/.claude/skills/FR3K/USER/SKILLCUSTOMIZATIONS/Art
```
...
See: `~/.claude/skills/FR3K/SYSTEM/SKILLSYSTEM.md` (Skill Customization System section)
