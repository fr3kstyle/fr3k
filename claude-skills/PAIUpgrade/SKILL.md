...
`~/.claude/skills/FR3K/USER/SKILLCUSTOMIZATIONS/PAIUpgrade/`
...
**Primary Purpose:** Generate prioritized upgrade recommendations for the user's existing FR3K setup by understanding their context and discovering what's new in the ecosystem.
...
│ FR3K System State    │         │ Community Updates   │
└─────────────────────┘         └─────────────────────┘
           │                              │
           └──────────┬───────────────────┘
                      ▼
...
**Granular. Extracted. FR3K-Contextualized.**

The output provides SPECIFIC TECHNIQUES extracted from actual content, not links to watch or recommendations to read. Every tip explains WHY it matters for YOUR FR3K system.
...
These are SPECIFIC techniques pulled from actual content. Each one maps to your FR3K system.
...
**How It Helps FR3K (16-32 words):**
[Describe the specific benefit to our FR3K system - which component improves, what gap it fills, what becomes possible. Must be 16-32 words.]
...
**Applies To:** `skills/FR3K/SKILL.md`, agent spawning
**Implementation:**
...
| # | Technique | Source | FR3K Component | Impact |
|---|-----------|--------|---------------|--------|
...
|---------|--------|-------------|
| [video/doc title] | [source] | [No extractable technique / Not relevant to FR3K / Covers basics you already know] |
...
3. **Map to FR3K components** - Every technique must connect to a specific file, skill, workflow, or system component
4. **Two mandatory description fields (16-32 words each):**
   ...
   - **How It Helps FR3K:** Describe the specific benefit - which component improves, what gap it fills, what becomes possible
...
| Agent | Focus | Sources |
|-------|-------|---------|
| **TELOS Agent** | User's goals, challenges, current focus | `skills/FR3K/USER/TELOS/*.md` |
...
| **FR3K State Agent** | System capabilities, installed skills, gaps | `skills/`, `hooks/`, `settings.json` |
...
- FR3K system state and existing capabilities
...
Read and analyze:
- ~/.claude/skills/FR3K/USER/TELOS/TELOS.md
- ~/.claude/skills/FR3K/USER/TELOS/GOALS.md
- ~/.claude/skills/FR3K/USER/TELOS/PROJECTS.md
- ~/.claude/skills/FR3K/USER/TELOS/CHALLENGES.md
- ~/.claude/skills/FR3K/USER/TELOS/STATUS.md
...
**User Customizations** (`~/.claude/skills/FR3K/USER/SKILLCUSTOMIZATIONS/PAIUpgrade/`):
...
3. **FR3K-Contextualized:** Every technique maps to a specific FR3K file, skill, or component
...
| "This helps because it improves things" | Vague benefit, no word count | "How It Helps FR3K (16-32 words): Our SecurityValidator currently only blocks commands. This technique enables injecting reasoning context before tool execution, making security decisions more nuanced." |
...
**Word count test:** Each "What It Is" and "How It Helps FR3K" field MUST be 16-32 words. Count them. If under 16, add specificity. If over 32, condense.

---

**This skill embodies FR3K's commitment to continuous, personalized improvement - understanding YOU first, then discovering what's new, then EXTRACTING the actual techniques that matter to your system.**
